...
/// 明信片配图：矩形 4:3 裁剪后上传（与头像圆形裁剪区分）。
class PostcardImageCropPage extends StatefulWidget {
  const PostcardImageCropPage({super.key, required this.imageBytes});

  final Uint8List imageBytes;

  @override
  State<PostcardImageCropPage> createState() => _PostcardImageCropPageState();
}

class _PostcardImageCropPageState extends State<PostcardImageCropPage> {
