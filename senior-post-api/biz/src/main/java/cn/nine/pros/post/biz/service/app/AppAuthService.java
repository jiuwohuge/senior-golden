...
import cn.nine.pros.post.biz.service.app.support.AppAuthProfileSupport;
import cn.nine.pros.post.biz.service.app.support.GoogleIdTokenVerifierService;
import cn.nine.pros.post.biz.service.app.support.GoogleIdTokenVerifierService.VerifiedGoogleIdentity;
...
public class AppAuthService {
    ...
    private AppAuthResultVO finishAuth(long userId, boolean profileComplete) {
        ...
        stampGrantService.afterLogin(userId);
